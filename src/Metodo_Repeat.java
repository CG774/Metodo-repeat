...
public class Metodo_Repeat extends javax.swing.JFrame {
    ...
    private void btnRepetirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRepetirActionPerformed
        ...
        String mensage = "Cadena original: " + cadena + "\n"
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Metodo_Repeat.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Metodo_Repeat().setVisible(true);
            }
        });
    }
